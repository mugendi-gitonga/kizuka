...
class PayoutRequestFilter(django_filters.FilterSet):
...
class PayoutRequestTable(tables.Table):
    alias_id = tables.Column(verbose_name="ID", order_by="id")
    amount = tables.Column(verbose_name="Amount")
    total_amount = tables.Column(verbose_name="Total Amount")
    ...
    def render_status(self, value):
        ...
        return status_colors.get(
            value, f'<span class="badge badge-secondary">{value}</span>'
        )
    ...
    class Meta:
        ...
        fields = ("alias_id", "amount", "total_amount", "status", "reference", "provider_reference", "created_at")
        attrs = {"class": "table table-striped table-bordered"}
        empty_text = "There are no payouts yet"
